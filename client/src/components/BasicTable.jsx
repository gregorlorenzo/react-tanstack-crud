...
const BasicTable = () => {
    ...
    const handleOpen = (modalType, rowData) => {
        if (modalType === 'create') {
            ...
            setIsEditOpen(false); // Ensure other modal is closed
            setIsDeleteOpen(false);
        } else if (modalType === 'edit') {
            setIsEditOpen(true);
            setIsCreateOpen(false); // Ensure other modal is closed
            setIsDeleteOpen(false);
            setCurrentRowData(rowData); // Set the current row data
        } else if (modalType === 'delete') {
    ...
    return (
        <div className='bg-white relative shadow-md sm:rounded-lg overflow-hidden'>
            ...
            <CreateModal isOpen={isCreateOpen} onClose={() => handleClose('create')} columns={columns} />
            <EditModal isOpen={isEditOpen} onClose={() => handleClose('edit')} rowData={currentRowData} columns={columns} />
            <DeleteModal isOpen={isDeleteOpen} onClose={() => handleClose('delete')} id={rowID} />
        </div>
    )
}
